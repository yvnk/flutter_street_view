          ...
          child: Stack(
            children: <Widget>[
              FlutterGoogleStreetView(
                initPos: SYDNEY,
                addressControlOptions: kIsWeb ? ControlPosition.top_center : null,
              ...
              if (_controller != null) PointerInterceptor(child: _optionsWidget()),
            ],
          ),
        ),
      ),
      ...
      Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.start, children: [
        Card(
          ...
          child: Column(
            ...
            children: [
              _option("Street Names", _controller!.isStreetNamesEnabled, (newValue) {
                _controller!.setStreetNamesEnabled(newValue!).then((value) {
                  setState(() {});
                });
              }),
              _option("Navigation", _controller!.isUserNavigationEnabled, (newValue) {
                _controller!.setUserNavigationEnabled(newValue!).then((value) {
                  setState(() {});
                });
              })
            ].also((it) {
              if (!kIsWeb) {
                it.addAll([
                  _option("Zoom Gestures", _controller!.isZoomGesturesEnabled, (newValue) {
                    _controller!.setZoomGesturesEnabled(newValue!).then((value) {
                      setState(() {});
                    });
                  }),
                  _option("Panning Gestures", _controller!.isPanningGesturesEnabled, (newValue) {
                    _controller!.setPanningGesturesEnabled(newValue!).then((value) {
                      setState(() {});
                    });
                  })
                ]);
                ...
                it.addAll([
                  _option("Address Control", _controller!.isAddressControl, (newValue) {
                    _controller!.setAddressControl(newValue!).then((value) {
                      setState(() {});
                    });
                  }),
                  _option("Close Button", _controller!.isEnableCloseButton, (newValue) {
                    _controller!.setEnableCloseButton(newValue!).then((value) {
                      setState(() {});
                    });
                  }),
                  _option("Full Screen Control", _controller!.isFullscreenControl, (newValue) {
                    _controller!.setFullscreenControl(newValue!).then((value) {
                      setState(() {});
                    });
                  }),
                  _option("Links Control", _controller!.isLinksControl, (newValue) {
                    _controller!.setLinksControl(newValue!).then((value) {
                      setState(() {});
                    });
                  }),
                  _option("Scroll Wheel", _controller!.isScrollwheel, (newValue) {
                    _controller!.setScrollwheel(newValue!).then((value) {
                      setState(() {});
                    });
                  }),
                  _option("Pan Control", _controller!.isPanControl, (newValue) {
                    _controller!.setPanControl(newValue!).then((value) {
                      setState(() {});
                    });
                  }),
                  _option("Zoom Control", _controller!.isZoomControl, (newValue) {
